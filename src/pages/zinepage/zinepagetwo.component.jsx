    ...
    <div className='wrapper'>
        <div className="grid__cell 1/1 2/3--desk 1/2--lap">
            <div className='zine-wrapper'>
                ...
                <br />
                    <br />
                    <b>And how many have you made so far?</b>
                <br />
                    <br />
                    Like total?
                <br />
                    <br />
                    <b>Seems like you have a bunch like almost every week there’s a new one. *laughs*</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>How did you originally get into zines and making them?</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>How do you feel about maximumrocknroll dying, I guess? *laughs*</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>You’ve gone to zine festivals as well.</b>
                <br />
                    <br />
                    Yeah a bunch of them.
                <br />
                    <br />
                    <b>Yeah I've never been to one because zines aren’t that popular in Finland right now. But yeah I don’t know what my question really is... what are they like, I guess? *laughs*</b>
                <br />
                    <br />
                    Fests are cool. It’s kind of... actually I’ll tell you about going to Helsinki Zine Fest because…
                <br />
                    <br />
                    <b>Oh yeah we have had that!</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>I had to write down so that I remember that you put zine pavilion in quotation marks because I won’t hear it.</b>
                <br />
                    <br />
                    Sorry I’ll say things...
                <br />
                    <br />
                    <b>No no no, that’s fine! *laughs* You did mention a zine festival in Helsinki so I’m gonna use that and start asking questions about Helsinki *laughs*</b>
                <br />
                    <br />
                    Yeah!
                <br />
                    <br />
                    <b>You were in Helsinki for a year-ish?</b>
                <br />
                    <br />
                    Oh not even 6 months barely, yeah.
                <br />
                    <br />
                    <b>What were your favorite bands that you saw in Finland?</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>Well I was like I know everyone by name who’s here.</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>Yeah, it’s interesting the bands you mention that you saw because like Acid Runs I don’t think they’ve played like they’ve played maybe one show after you saw them. But they’re still around but just the bands you mentioned sort of felt they kind of feel like those bands were playing all the time like two years ago and it changes so fast.</b>
                <br />
                    <br />
                    It really does!
                <br />
                    <br />
                 <b>But the same people have other bands so it’s alright!</b>
                <br />
                    <br />
                    Yeah, definitely.
                <br />
                    <br />
                    <b>And like Tuntematon Tie hardly every play, unfortunately. We actually with Pete TNT Band we played a Tuntematon Tie song cause it was like every member but one from Tuntematon Tie and a couple of extra people. So we were like we’re just gonna play Tuntematon Tie. Why not?</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>*laughs* That's awesome! Big Clown!</b>
                <br />
                    <br />
                    Yeah.
                <br />
                    <br />
                    <b>How did that start?</b>
                <br />
                    <br />
                ...
                <br />
                    <br />
                    <b>I’ll add links to all of that stuff as well!</b>
                <br />
                    <br />
        ...
        <div className="grid__cell 1/1 1/3--desk 1/2--lap">
            ...
            <div className="promo-wrapper">
                <img className="promo" src="https://f4.bcbits.com/img/0015300465_10.jpg" alt="error" />
            </div>
            <div className="space"></div>
            <div className="promo-wrapper">
                <img className="promo" src="https://f4.bcbits.com/img/0019582261_10.jpg" alt="error" />
            </div>
            <div className="space"></div>
            <div className="promo-wrapper">
                <img className="promo" src="https://f4.bcbits.com/img/0019582264_10.jpg" alt="error" />
            </div>
            <div className="space"></div>
            <div className='zine-wrapper zine-wrapper__multimedia'>
                <div className='player-wrapper'>
                    <ReactPlayer
                        ...
                        width='100%'
                        height='100%'
                        url="https://youtu.be/4dEzxvKy8rA" />
                </div>
            </div>
            <div className="space"></div>
            <div className='zine-wrapper zine-wrapper__multimedia'>
                <div className='player-wrapper'>
                    <ReactPlayer
                        ...
                        width='100%'
                        height='100%'
                        url="https://youtu.be/SS2yTzSph1Y" />
                </div>
            </div>
            <div className="space"></div>
            <div className='zine-wrapper zine-wrapper__multimedia'>
                <div className='player-wrapper'>
                    <ReactPlayer
                        ...
                        width='100%'
                        height='100%'
                        url="https://youtu.be/d27sFceRpcI" />
                </div>
            </div>
            <div className="space"></div>
        </div>
